  ...
  constructor(props) {
    ...
    this.state = {
      ...
      tabIndexesMain: {
        ...
        [this.props.appUrls.competency]: 94,
        [this.props.appUrls.vocal]: 104,
        [this.props.appUrls.pauses]: 114,
        [this.props.appUrls.disfluencies]: 124,
        [this.props.appUrls.modulation]: 134,
        [this.props.appUrls.videosummary]: 144,
      },
      currentIndex: null,
      currentItem: null,
      articles: [],
    ...
    this.setState(
      {
        tabIndexes: {
          ...
          'soft-skills': 94,
          'vocal-features': 104,
          'appropriate-pauses': 114,
          disfluencies: 124,
          'speech-modulation': 134,
        },
      },
      () => {
